...
app.post('/platos', async (req, res) => {
    ...
    await Platos
        .create({nombre,precio,tipo_de_plato}) //cómo recibo este error? en el caso de que el tipo esperado sea distinto al esperado.
        .then(res.send(`El plato "${nombre}" fue agregado`))
        .catch(console.log('Problema al crear el plato. Continua ejecutando porque no hay return'))
    });
...
app.put('/platos/:nombre', plato_existe_por_nombre, async (req, res) => {
    await Platos
        ...
        .catch(console.log('Problema al modificar el plato. Continua ejecutando porque no hay return'))
});
...
app.delete('/platos/:nombre', plato_existe_por_nombre, async (req, res) => {
    await Platos
        ...
        .catch(console.log('Problema al borrar el plato. Continua ejecutando porque no hay return'))
});
